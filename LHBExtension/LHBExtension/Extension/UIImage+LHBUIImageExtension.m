...
+ (UIImage *)lhb_imageWithName:(NSString *)name withKey:(NSString *)key
{
    //皮肤文件夹名字 red blue等,要从沙盒中取出
    NSString *dir = [[NSUserDefaults standardUserDefaults] stringForKey:key];
    //文件全路径
